...
fetch(url).then(function(respuesta){
    ...
    for(let i = 0; i < datos.length; i++ ){
        console.log(datos[i]);
        contenedor.innerHTML += "<div class='Apartados'> <a href='Subpaginas/Noticias.html'> <img src='"+uri+datos[i]["imagen"]+"' class='Destacado'> <h4>"+datos[i]["nombre"]+" <span>"+datos[i]["Info"]+" </span> </h4> </a> </div> </div> ";
